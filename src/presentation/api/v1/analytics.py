...
from domain.permissions.users import IsAdmin, IsAdminOrIsOwner
...
async def get_all_actions(user_id: int, period: Period, permission=Depends(IsAdmin())):
...
async def get_all_tasks(user_id: int, period: Period, permission=Depends(IsAdmin())):
...
async def get_all_sheets(user_id: int, period: Period, permission=Depends(IsAdmin())):
